...
import com.nomad.android36.databinding.ItemMusicBinding;

import java.util.ArrayList;

public class AdapterMusic extends RecyclerView.Adapter<AdapterMusic.CountViewHolder> {
    private Context context;
    private OnClick onClick;

    ArrayList<Music> list = new ArrayList<>();

    public AdapterMusic(ArrayList<Music> list,OnClick onClick) {
        this.list = list;
